...
export default function HeroCard({ totalAmount = "Rp 0", monthlyChange = "+Rp 0" }: HeroCardProps) {
    return (
        <section className="mb-6 md:mb-12">
            <div className="relative overflow-hidden rounded-2xl md:rounded-3xl p-5 md:p-10 bg-gradient-to-br from-[#7ca29d]/20 via-[#e0f2f1]/30 to-[#fef3c7]/30">
                ...
                <div className="relative z-10 glass-card rounded-xl md:rounded-2xl p-4 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
                    ...
                    <div className="w-full md:w-auto">
                        <div className="text-center md:text-left px-4 md:px-8 py-2.5 md:py-4 border-l-2 border-[#7ca29d]/20 bg-white/40 rounded-2xl md:rounded-3xl backdrop-blur-sm">
